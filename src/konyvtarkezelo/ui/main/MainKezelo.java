 ...
 */
package konyvtarkezelo.ui.main;
...
public class MainKezelo implements Initializable {
    ...
    private void loadAddMember(ActionEvent event) {
        loadWindow("/konyvtar/ui/addmember/add_member.fxml", "Tag hozzáadás");
    }

    @FXML
    private void loadAddBook(ActionEvent event) {
        loadWindow("/konyvtar/ui/addbook/view_2.fxml", "Könyv hozzáadás");
    }
    ...
    private void loadBookList(ActionEvent event) {
        loadWindow("/konyvtarkezelo/ui/konyvlista/konyv_lista.fxml", "Tag hozzáadás");
    }
    
        @FXML
    private void loadSettings(ActionEvent event) {
        loadWindow("/konyvtarkezelo/beallitasok/beallitasok.fxml", "Beallitasok");
    }
