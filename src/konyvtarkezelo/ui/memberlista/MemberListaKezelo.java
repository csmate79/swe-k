...
import konyvtar.ui.addmember.MemberAddKezelo;
...
//        MemberListaKezelo.Member selectedForDeletion = tableView.getSelectionModel().getSelectedItem();
//        if (selectedForDeletion == null) {
//            AlertMaker.showErrorMessage("No member selected", "Please select a member for deletion.");
//            return;
//        }
//        if (AdatbazisKezelo.getInstance().isMemberHasAnyBooks(selectedForDeletion)) {
